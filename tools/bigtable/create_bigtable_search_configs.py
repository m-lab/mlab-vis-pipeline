...
def build_location_client_asn_number_list():
    print("location_client_asn_number_list")
...
def build_location_client_asn_number_list_sql():
    '''
    Builds the sql query for the location_client_asn_number_list table
    '''
    ...
    config = AGGREGATIONS["location_client_asn_number_list"]
...
def build_location_client_asn_number_list_json():
    '''
    Builds the location_client_asn_number_list table json structure
    for big table
    '''
    config = AGGREGATIONS["location_client_asn_number_list"]
    json_struct = setup_base_json("location_client_asn_number_list", config)
...
def build_location_list_json():
    '''
        ...
        for big table
    '''
    config = AGGREGATIONS["location_list"]
    json_struct = setup_base_json("location_list", config)
...
def build_location_list_sql():
    '''
        Builds the location_list table sql query file
        for big table
    '''
...
def build_location_search_json():
    ...
    config = AGGREGATIONS["location_search"]
    json_struct = setup_base_json("location_search", config)
