...
all.server_asn_name = last_three_months.server_asn_name and 
all.server_asn_number = last_three_months.server_asn_number
left join
(
  SELECT
    count(*) as test_count,
...
all.server_asn_name = last_six_months.server_asn_name and 
all.server_asn_number = last_six_months.server_asn_number
left join
(
  SELECT
    count(*) as test_count,
