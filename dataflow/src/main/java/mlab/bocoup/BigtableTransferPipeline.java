...
public class BigtableTransferPipeline {
	...
	private static final String DEFAULT_BIGTABLE_CONFIG_FILE = "./data/bigtable/client_loc_server_asn_list.json";
	...
	public static void main(String[] args) {
		...
		BigtableTransferPipeline.runAll(args, "", "_search.json");
